<template>
	<div id="app">
		...
		<hr>
		<p v-destaque.atrasar="'teal'">Usando diretiva personalizada</p>
		...
		<p v-destaque-local:fundo.atrasar.alternar="{cor1: 'lightblue', cor2: 'lightgreen', atraso: 2000, intervalo: 200}">Usando diretiva personalizada</p>
	</div>
</template>
